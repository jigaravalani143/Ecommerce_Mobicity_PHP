...
if(isset($_POST["category"])){
	...
	$run_query = mysqli_query($connection,$category_query) or die(mysqli_error($connection));
	echo "
...
if(isset($_POST["brand"])){
	...
	$run_query = mysqli_query($connection,$brand_query);
	echo "
		<div class='nav nav-pills nav-stacked'>
...
if(isset($_POST["get_seleted_Category"]) || isset($_POST["selectBrand"]) || isset($_POST["search"])){
	if(isset($_POST["get_seleted_Category"])){
		...
		$sql = "SELECT * FROM products WHERE tags LIKE '%$keyword%'";
	}
...
if (isset($_POST["Common"])) {
	...
	if (isset($_SESSION["uid"])) {
		...
		$sql = "SELECT a.product_id,a.product_name,a.price,a.image,b.id,b.qty FROM products a,cart b WHERE a.product_id=b.p_id AND b.user_id='$_SESSION[uid]'";
	}else{
		//When user is not logged in this query will execute
		$sql = "SELECT a.product_id,a.product_name,a.price,a.image,b.id,b.qty,a.details FROM products a,cart b WHERE a.product_id=b.p_id AND b.ip_add='$ip_add' AND b.user_id < 0";
	}
	$query = mysqli_query($connection,$sql);
			...
			while ($row=mysqli_fetch_array($query)) {
				...
				echo '
					<div class="row">
						...
						<div class="col-md-3"><img class="img-responsive" src="product_images/'.$image.'" /></div>
				...
				while ($row=mysqli_fetch_array($query)) {
					...
					echo 
						'<div class="row">
								...
								<div class="col-md-2"><img class="img-responsive" src="product_images/'.$image.'"></div>
								<div class="col-md-2">'.$product_name.'</div>
								<div class="col-md-2"><input type="text" class="form-control qty" value="'.$qty.'" ></div>
								<div class="col-md-2"><input type="text" class="form-control price" value="'.$price.'" readonly="readonly"></div>
								<div class="col-md-2"><input type="text" class="form-control total" value="'.$price.'" readonly="readonly"></div>
							</div>';
				}
