...
<?php 
$result=mysqli_query($connection,"select order_id, p_names, cus_name, contact_no, email, address, country, details,zip_code, country, quantity from orders order by country Desc Limit $page1,10")or die ("query 1 incorrect.....");
