...
while($row=mysqli_fetch_array($results))
	...
	mysqli_query($connection,"insert into orders(details, cus_name,contact_no, email, address, zip_code, country,quantity) values ('$details', '$name', '$contactno','$email','$address', '$zip_code', '$country', '$quantity')") or die ("query 2 incorrect");
